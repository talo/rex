...
pub struct Ftable<S: Send + Sync + 'static> {
    ...
    pub ftable2: HashMap<(Id, Type), (Function, FtableFn<S>)>,
}
...
impl<S: Send + Sync + 'static> Ftable<S> {
    ...
    //                                 }),
    //                                 // Implementation
    //                                 Some(Value::Dict(fields)) => Ok(Value::Data(Data {
    //                                     name: variant.name.clone(),
    ...
    //                                 }),
    //                                 // Implementation
    //                                 Some(tuple @ Value::Tuple(fields)) => Ok(Value::Data(Data {
    //                                     name: variant.name.clone(),
